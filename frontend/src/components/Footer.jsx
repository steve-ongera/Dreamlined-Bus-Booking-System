      ...
      <div className="container">
        <div className="row g-3">
          ...
          <div className="col-12 col-md-5 col-lg-4">
            <div className="d-flex align-items-center gap-2 mb-2">
              {/* Logo on white-tinted pill so it shows on the dark footer */}
              <div style={{
                ...
                <img
                  ...
                  style={{ width: 34, height: 34, objectFit: 'contain', display: 'block', borderRadius: 5 }}
                />
              </div>
              <div>
            ...
            <div className="d-flex gap-2">
              {['bi-facebook', 'bi-twitter-x', 'bi-instagram', 'bi-youtube'].map(icon => (
                ...
                >
                  <i className={`bi ${icon}`} style={{ fontSize: '.8rem' }} />
                </a>
              ))}
            </div>
          </div>
              ...
              {[
                ...
                <li key={l.to}>
                  <Link to={l.to} style={{ color: 'rgba(255,255,255,.65)', fontSize: '.82rem', display: 'flex', alignItems: 'center', gap: 5 }}>
                    <i className="bi bi-chevron-right" style={{ fontSize: '.62rem' }} />
                    {l.label}
                  </Link>
                </li>
              ))}
              ...
              {[
                ...
                <li key={r}>
                  <a href="/" style={{ color: 'rgba(255,255,255,.65)', fontSize: '.82rem', display: 'flex', alignItems: 'center', gap: 5 }}>
                    <i className="bi bi-arrow-right" style={{ fontSize: '.62rem', color: 'var(--dl-red)' }} />
                    {r}
                  </a>
                </li>
              ))}
          ...
          <div className="col-12 col-md-12 col-lg-3">
            ...
            <ul className="list-unstyled d-flex flex-column gap-2" style={{ fontSize: '.82rem' }}>
              <li className="d-flex gap-2">
                <i className="bi bi-geo-alt-fill" style={{ color: 'var(--dl-red)', marginTop: 2, flexShrink: 0, fontSize: '.85rem' }} />
                <span style={{ color: 'rgba(255,255,255,.65)' }}>Ronald Ngala Street, Nairobi CBD</span>
              </li>
              <li className="d-flex gap-2">
                <i className="bi bi-telephone-fill" style={{ color: 'var(--dl-red)', flexShrink: 0, fontSize: '.85rem' }} />
                <a href="tel:+254700000000" style={{ color: 'rgba(255,255,255,.65)' }}>+254 700 000 000</a>
              </li>
              <li className="d-flex gap-2">
                <i className="bi bi-envelope-fill" style={{ color: 'var(--dl-red)', flexShrink: 0, fontSize: '.85rem' }} />
                <a href="mailto:info@dreamline.co.ke" style={{ color: 'rgba(255,255,255,.65)', wordBreak: 'break-all' }}>info@dreamline.co.ke</a>
              </li>
              <li className="d-flex gap-2">
                <i className="bi bi-clock-fill" style={{ color: 'var(--dl-red)', flexShrink: 0, fontSize: '.85rem' }} />
        ...
        <div className="footer-bottom">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 8, marginBottom: 6 }}>
            ...
            <p style={{ margin: 0 }}>© {new Date().getFullYear()} Dreamline Bus Services. All rights reserved.</p>
          </div>
          <div className="d-flex justify-content-center gap-3 flex-wrap" style={{ fontSize: '.75rem' }}>
